...
class Ui_DED_Monitoring(object):
    def setupUi(self, DED_Monitoring):
        ...
        self.gridLayout.addWidget(self.rem_pos_box, 0, 7, 1, 1)

        self.label_pyro_status = QLabel(self.frame_3)
        self.label_pyro_status.setObjectName(u"label_pyro_status")

        self.gridLayout.addWidget(self.label_pyro_status, 5, 6, 1, 1)

        self.label_ipg_status = QLabel(self.frame_3)
        self.label_ipg_status.setObjectName(u"label_ipg_status")

        self.gridLayout.addWidget(self.label_ipg_status, 5, 7, 1, 1)

        self.label_camera_status = QLabel(self.frame_3)
        self.label_camera_status.setObjectName(u"label_camera_status")

        self.gridLayout.addWidget(self.label_camera_status, 5, 0, 1, 1)
    ...
    def retranslateUi(self, DED_Monitoring):
        ...
        self.label_pyro_status.setText(QCoreApplication.translate("DED_Monitoring", u"Disconnected", None))
        self.label_ipg_status.setText(QCoreApplication.translate("DED_Monitoring", u"Disconnected", None))
        self.label_camera_status.setText(QCoreApplication.translate("DED_Monitoring", u"Disconnected", None))
